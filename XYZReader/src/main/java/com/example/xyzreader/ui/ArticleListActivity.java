...
public class ArticleListActivity extends ActionBarActivity implements
    ...
    /* CLASS ATTRIBUTES - ArticleListActivity */
    private Toolbar mToolbar;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private RecyclerView mRecyclerView;
    private CollapsingToolbarLayout mCollpasingToolbarLayout;
    ...
    private void updateRefreshingUI() {
        Log.d(LOG_TAG, "Update refreshing received");
    ...
    private class Adapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            //holder.titleView.setTypeface(Typeface.createFromAsset(getResources().getAssets(), "Roboto-Black.ttf"));
